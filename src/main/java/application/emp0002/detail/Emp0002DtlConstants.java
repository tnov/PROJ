...
public class Emp0002DtlConstants {
	public static final String CONTENTS_PATH = "/WEB-INF/jsp/application/emp0002/emp0002dtl.jsp";

	public static final String CUSTOMER_ID = "顧客ＩＤ";
	public static final String CUSTOMER_NAME = "顧客名称";
	public static final String ZIP_CODE = "郵便番号";
	public static final String ADDRESS = "住所";
	public static final String LIAISON = "担当窓口";
	public static final String STAFF = "担当者";
	public static final String TEL = "電話番号";
	public static final String DEVELOPMENT = "開発業務";
	public static final String MAINTENANCE = "保守業務";
